...
class PhpIpamPlugin extends Plugin {
	...
	@Override
	String getCode() {
		return 'morpheus-phpipam-plugin'
	}

	@Override
	void initialize() {
		 PhpIpamProvider phpIPAMProvider = new PhpIpamProvider(this, morpheus)
		 this.pluginProviders.put("phpipam", phpIPAMProvider)
		 this.setName("phpIPAM")
	}
